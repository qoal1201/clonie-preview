...
/// 그 값이 앉는 자리(`Config/BackendConfig.swift`)는 둘 다 executable(`Sources/Clonie`)
/// 안이라 **`swift test` 가 못 부른다** — `ClonieCore`(#8)·`ClonieEmbedding`(#31)·
/// `ClonieIndex`(#32)·`CloudDraftWire`(#51) 를 뽑은 것과 **똑같은 이유**다.
