...
enum IndexTestSupport {
    ...
    static func makeTempDirectory(_ label: String) throws -> URL {
        let url = FileManager.default.temporaryDirectory
            .appendingPathComponent("ghostbar-index-\(label)-\(UUID().uuidString)", isDirectory: true)
